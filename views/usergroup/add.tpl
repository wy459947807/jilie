                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        ...
                        <dl class="permission-list">
                            <dt>
                                <label>
                                    <input type="checkbox" value="<!--{$val.name}-->" name="rbac[]" id="user-Character-<!--{$key}-->">
                                    <!--{$val.name}-->
                                </label>
                            </dt>
                            <dd>
                                ...
                                <dl class="cl permission-list2">
                                    <dt>
                                        <label class="">
                                            <input type="checkbox" value="<!--{$v.name}-->" name="rbac[]" id="user-Character-<!--{$key}-->-<!--{$k}-->">
                                            <!--{$v.name}--></label>
                                    </dt>
                                    <dd>
                                        ...
                                        <label class="">
                                            <input type="checkbox" value="<!--{$n.path}-->" name="rbac[]" id="user-Character-<!--{$key}-->-<!--{$k}-->-<!--{$i}-->">
                                            <!--{$n.name}--></label>
                                        <!--{/foreach}-->
                                        <!--{/if}-->
                                    </dd>
